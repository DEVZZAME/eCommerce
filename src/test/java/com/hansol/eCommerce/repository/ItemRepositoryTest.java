...
import com.hansol.eCommerce.entity.QItem;
...
class ItemRepositoryTest {
    ...
    public void findByPriceGreaterThan() {
        this.createItemList();
        List<Item> itemList = itemRepository.findByPriceGreaterThan(10_005);
        for (Item item : itemList) {
            System.out.println(item.toString());
        }
    }
    ...
    public void findByPriceLessThanOrderByPriceDescTest() {
        this.createItemList();
        List<Item> itemList = itemRepository.findByPriceLessThanOrderByPriceDesc(10_002);
        for (Item item : itemList) {
            System.out.println(item.toString());
        }
    }
